...
- `Alertas de obras publicas paralizadas en el Peru a mayo 2026.mhtml`: infografia descargable.

## Funcionalidades

- Mapa interactivo con obras distribuidas en los 25 departamentos.
- Filtros por palabra clave, departamento, nivel de gobierno, sector, causa, costo y tiempo paralizado.
...
- Seccion Descargables con base de datos, documento de trabajo e infografia.

## Uso

Abrir `index.html` en el navegador o publicar la carpeta completa en GitHub Pages.
